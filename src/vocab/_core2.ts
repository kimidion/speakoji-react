...
export const core2 = {
    ...
    words: [
        ...
        { y: 2, x: 6,  word: "get", icon: "", emoji: "", expand: ["got", "getting", "gotten"] },
        ...
        { y: 6, x: 1,  word: "animals", icon: "", emoji: "🐾", action: ACTIONS.PAGE },
        { y: 6, x: 2,  word: "", icon: "", emoji: "", action: ACTIONS.PAGE },
        { y: 6, x: 3,  word: "plants", icon: "", emoji: "🌿", action: ACTIONS.PAGE },
        { y: 6, x: 4,  word: "", icon: "", emoji: "", action: ACTIONS.PAGE },
        { y: 6, x: 5,  word: "weather", icon: "", emoji: "", action: ACTIONS.PAGE },
        ...
        { y: 6, x: 10, word: "media", icon: "important_devices", action: ACTIONS.PAGE }, // read, books, watch, tv, phone, device, magazines, movies, shows
    ]
};